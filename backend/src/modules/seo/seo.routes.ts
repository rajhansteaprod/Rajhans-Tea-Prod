...
adminRouter.post('/seo/recommendations/:id/approve-draft', ctrl.approveRecommendationDraft);
...
adminRouter.get('/seo/change-executions/:executionId/publication', ctrl.getExecutionPublication);
