  ...
  navSections: NavSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Variant Options', icon: '<svg viewBox="0 0 24 24"><circle cx="12" cy="5" r="2"/><circle cx="19" cy="12" r="2"/><circle cx="12" cy="19" r="2"/><circle cx="5" cy="12" r="2"/></svg>', route: '/admin/variant-options' },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Reviews', icon: '<svg viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" stroke="currentColor" stroke-width="2" fill="none" stroke-linejoin="round"/></svg>', route: '/admin/reviews' },
      ],
    },
    {
      label: 'PEOPLE',
    ...
    },
    {
      ...
      collapsed: false,
      items: [
        { label: 'SEO Audit', icon: '<svg viewBox="0 0 24 24"><circle cx="11" cy="11" r="7" stroke="currentColor" stroke-width="2" fill="none"/><line x1="21" y1="21" x2="16.65" y2="16.65" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>', route: '/admin/seo' },
        { label: 'SEO Recommendations', icon: '<svg viewBox="0 0 24 24"><path d="M9 18h6M10 21h4M12 3a6 6 0 0 0-4 10.5c.7.7 1 1.2 1 2.5h6c0-1.3.3-1.8 1-2.5A6 6 0 0 0 12 3z" stroke="currentColor" stroke-width="2" fill="none" stroke-linejoin="round"/></svg>', route: '/admin/seo/recommendations' },
        { label: 'SEO Agent', icon: '<svg viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="2" stroke="currentColor" stroke-width="2" fill="none"/><path d="M8 9h8M8 13h5M8 17h3" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>', route: '/admin/seo/agent' },
