# Production Deployment Guide — Rajhans Tea
...
NODE_ENV=production
PORT=3000
MONGO_URI=mongodb+srv://<user>:<pass>@cluster.mongodb.net/rajhans-tea?retryWrites=true
...
SMTP_USER=apikey
SMTP_PASS=SG.xxxxx
SMTP_FROM=Rajhans Tea <noreply@rajhanstea.com>
```
...
docker images rajhanstea-backend --format "table {{.ID}}\t{{.CreatedAt}}"

# 2. Tag previous image as latest
docker tag <previous-image-id> rajhanstea-backend:latest
